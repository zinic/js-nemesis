...
(function () {
    ...
    function SystemCore() {
        ...
        this.isolate = function (closure, context, safety) {
            // Create a new iframe
            ...
            if (is_set(context)) {
                for (var key in context) {
                    if (is_not_set(safety) || safety) {
                        isowin[key] = System.clone(context[key]);
                    } else {
                        isowin[key] = context[key];
                    }
                }
            }
            ...
            return is_not_set(safety) || safety ? System.clone(result) : result;
        };
